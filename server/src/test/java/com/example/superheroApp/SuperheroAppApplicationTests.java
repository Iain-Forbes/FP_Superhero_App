...
class SuperheroAppApplicationTests {
	...
	public void canCreateSaveUserToDB(){
		Hero hero = new Hero("Mr Strong", "1-mr-strong", 2, 50, 32, 100, 100, 100, "https://static.wikia.nocookie.net/mrmen/images/6/60/Strong3.png/revision/latest/scale-to-width-down/340?cb=20181002021322");
		User user = new User("Iain", List.of(hero));
